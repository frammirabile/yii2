...
class Security extends Component
{
     ...
     * @param null|string $info optional context and application specific information, see [[hkdf()]]
     * @return string the encrypted data
     * @throws Exception
     * @throws InvalidConfigException
     * @see decryptByKey()
     ...
     * @param null|string $salt the random salt
     * @param null|string $info optional info to bind the derived key material to application-
     ...
     *
     * @param string $data the data to be validated. The data must be previously generated by [[hashData()]].
     ...
     * @throws \Exception
     */
    public function generateRandomInteger(int $length = 5): int
    {
     ...
     * @param null|int $cost cost parameter used by the Blowfish hash algorithm.
